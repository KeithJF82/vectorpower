...
cohort_data_con <- cohort(mainpop_data=mainpop_data,cluster_data=cluster_list_con,n_patients = 100,prop_T_c = 0.9,
...
cohort_data_int <- cohort(mainpop_data=mainpop_data,cluster_data=cluster_list_int,n_patients = 100,prop_T_c = 0.9,
                          age_start = 0.5,age_end = 10.0,flag_output = 0, test_time_values = 14.0*c(1:10), 
                          test_type = "RDT", flag_pre_clearing = 1, censor_period = 14.0, flag_reactive_treatment = 1)
```
