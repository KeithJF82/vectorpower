...
```{r}
mainpop_data <- mainpop(input_data = input_data, n_mv_set = n_mv_set, int_v_varied = int_v_varied, 
...
```{r}
plot1 <- get_mainpop_data(input_list=mainpop_data,set_n_mv=c(1:5),set_n_int=1,benchmark="slide_prev",age_start=0.0,age_end = 65.0)
plot2 <- get_mainpop_data(input_list=mainpop_data,set_n_mv=c(1:5),set_n_int=2,benchmark="slide_prev",age_start=0.0,age_end = 65.0)
par(mfrow=c(1,2))
