...
In this example, the folder containing all three parameter files (the inst/extdata/param_examples folder inside the main vectorpower folder) is specified, with the individual filenames concatenated with the folder name to specify their locations. To run the example on your own computer, change input_location to give the location where you have installed vectorpower.

```{r}
input_location = "inst/extdata/param_examples/"
param_file=paste(input_location,"model_parameters_Mali.txt",sep="")
