---
title: "Worked Example 4 - Cohort Simulation 1"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Worked Example 4 - Cohort Simulation 1}
...
This is an example of how to take previously created main population and trial cluster data and and run stochastic simulations of the individuals in the cohort in each cluster, producing prevalence and incidence results for each cohort.

A more detailed cohort model including additional features and producing individual data suitable for use in power calculations is described in Worked Example 5(link).
